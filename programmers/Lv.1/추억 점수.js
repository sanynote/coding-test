...
let nameList = ['jee','hee','jeong']
let yearning = [10,5,1]
let photo = [['bin','jee','hee','hoon'], ['jee','hee'] ,['jee','hee','jeong']] 
...
obj[a[i]] = b[i]
    ...
    // reduce 처음 써봐서 어려웠음 ㅠ

    return c.map((value)=>value.map((v)=>obj[v] ? obj[v] : 0).reduce((acc,cur)=>acc+cur))

}

console.log(solution(nameList,yearning,photo))
